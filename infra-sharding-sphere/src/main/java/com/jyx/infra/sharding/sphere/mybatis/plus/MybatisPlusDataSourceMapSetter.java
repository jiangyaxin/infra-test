...
public final class MybatisPlusDataSourceMapSetter {
    ...
    public static Map<String, DataSource> getDataSourceMap(final Environment environment, Map<String, DataSource> existMap) {
        Map<String, DataSource> result = new LinkedHashMap<>();
        for (String each : getDataSourceNames(environment)) {
            try {
                if (existMap.containsKey(each)) {
                    DataSource value = existMap.get(each);
                    if (value instanceof ItemDataSource) {
                        value = ((ItemDataSource) value).getDataSource();
                    }
